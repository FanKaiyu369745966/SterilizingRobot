    ...
    : QDialog(parent)
{
    ...
    ui.tableLocalChannel->horizontalHeader()->setResizeContentsPrecision(QHeaderView::Stretch);
	ui.tableLocalChannel->setColumnCount(1);
    ui.tableRemoteChannel->horizontalHeader()->setResizeContentsPrecision(QHeaderView::Stretch);

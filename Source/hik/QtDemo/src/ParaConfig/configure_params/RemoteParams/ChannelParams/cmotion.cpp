    ...
    : QDialog(parent)
{
    ...
    ui.tableChannel->horizontalHeader()->setResizeContentsPrecision(QHeaderView::Stretch);
    ui.tableAlarmOut->horizontalHeader()->setResizeContentsPrecision(QHeaderView::Stretch);
